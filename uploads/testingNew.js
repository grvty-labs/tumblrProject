...
/***/function (module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(MainView, null), document.getElementById('app'));
...
/***/function (module, exports, __webpack_require__) {
	...
	var MainView = React.createClass({
		...
		render: function render() {
			...
			return React.createElement('div', null, React.createElement(Carousel, { width: this.state.width,
				images: this.state.images,
				ease: this.state.ease,
				duration: this.state.duration,
				layout: this.state.layout }), React.createElement('table', null, React.createElement('tr', null, React.createElement('td', null, React.createElement('label', { htmlFor: 'panel-count' }, 'Panels')), React.createElement('td', null, React.createElement('input', { type: 'range', id: 'panel-count',
				value: this.state.images.length, min: '3', max: '20',
				onChange: this.onSides })), React.createElement('td', null, React.createElement('span', null, this.state.sides))), React.createElement('tr', null, React.createElement('td', null, 'Layout'), React.createElement('td', null, React.createElement('select', { onChange: this.onLayout, value: this.state.layout }, React.createElement('option', { value: 'prism' }, 'prism'), React.createElement('option', { value: 'classic' }, 'classic')))), React.createElement('tr', null, React.createElement('td', null, React.createElement('label', { htmlFor: 'duration' }, 'Duration')), React.createElement('td', null, React.createElement('input', { type: 'range', id: 'duration',
				value: this.state.duration, min: '0', step: '250', max: '1500',
				onChange: this.onDuration })), React.createElement('td', null, React.createElement('span', null, this.state.duration))), React.createElement('tr', null, React.createElement('td', null, 'Ease'), React.createElement('td', null, React.createElement('select', { onChange: this.onEase, value: this.state.ease }, easeList)))));
		}
	});
	...
	var Carousel = React.createClass({
		...
		render: function render() {
			...
			var figures = this.state.figures.map(function (d, i) {
				return React.createElement('figure', { key: i, style: Util.figureStyle(d) }, React.createElement('img', { src: d.image, alt: i, height: '100%', width: '100%' }));
			});
			return React.createElement('section', { className: 'react-3d-carousel' }, React.createElement('div', { className: 'carousel',
				style: { transform: 'translateZ(' + translateZ + 'px)' } }, figures), React.createElement('div', { className: 'prev', onClick: Util.partial(this.onRotate, +angle) }), React.createElement('div', { className: 'next', onClick: Util.partial(this.onRotate, -angle) }));
		}
	});
...
/***/function (module, exports) {
	...
	module.exports = ['http://s7.postimg.org/dbamgegu3/zen8.jpg', 'http://s21.postimg.org/er8b066p3/zen2.jpg', 'http://s4.postimg.org/6mbbcgmwd/zen1.jpg', 'http://s30.postimg.org/x3cgpdtgx/zen3.jpg', 'http://s21.postimg.org/h1estw95z/zen4.jpg', 'http://s8.postimg.org/upypfrk8l/zen5.jpg', 'http://s7.postimg.org/goiv34aez/zen6.jpg', 'http://s30.postimg.org/n9zuqbgq9/zen7.jpg', 'http://s12.postimg.org/9kw5b42d9/zen9.jpg', 'http://s13.postimg.org/vwf92qbl3/zen10.jpg', 'http://s4.postimg.org/anf2w9rzh/zen11.jpg', 'http://s17.postimg.org/gpbiwdsu7/zen12.jpg', 'http://s9.postimg.org/n5uuedw3z/zen13.jpg', 'http://s9.postimg.org/x6zonp973/zen14.jpg', 'http://s2.postimg.org/r0vsbv8op/zen15.jpg', 'http://s21.postimg.org/szu5d0h2f/zen16.jpg', 'http://s15.postimg.org/xi59nxox7/zen17.jpg', 'http://s8.postimg.org/zexjdajw5/zen18.jpg', 'http://s24.postimg.org/st2ukrfz9/zen19.jpg', 'http://s15.postimg.org/40kb5u63v/zen20.jpg'];
